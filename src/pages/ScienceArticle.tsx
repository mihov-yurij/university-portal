...
//       <section className="relative bg-[url('/img/window.png')] bg-cover bg-center bg-no-repeat text-blue-500 py-12 md:py-20">
...
//         </div>
//       </section>
//       <section><div><p>Усі викладачі мають активні профілі Google Scholar. Середній показник h-індексу в Google Scholar становить "5.7". Більш ніж 80% колективу мають Scopus Author ID, що свідчить про інтеграцію кафедри у світовий науковий простір. Середній рівень h-індексу в Scopus складає 2.
//         </p></div></section>
...
//     onClick={() => loadPdf('article_2.pdf')}
//   >
//     <FileCheck size={20} />
//     <span>Кількість наукових статей, які індексуються у Scopus та/або WoS в наукових журналах </span>
//   </button>
// </div>
//       {activeDoc && (
...
export default function ScienceArticle() {
  ...
  <div className="mt-10 bg-white rounded-xl shadow-lg border overflow-hidden flex flex-col h-[700px] md:h-[900px]">
    ...
    {/* Область со страницами (растянута) */}
