        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-10 items-start">
            ...
            <div className="w-full lg:w-1/2">
              <div className="text-lg text-black leading-relaxed text-justify mb-12">
                <h1 className="text-4xl font-bold text-blue-700 uppercase tracking-tight">ЗВІТ З НАУКОВОЇ РОБОТИ ЗА 2021-2025 РОКИ </h1>
                <h3 className="mb-6 text-2xl text-sm text-yellow-400 italic">Кафедра здійснює наукову роботу за такими основними напрямами:</h3>
                <p className="mb-4">•	виконання держбюджетних і госпрозрахункових науково-дослідних робіт;
...
У 2023 році кафедрою подавалась заявка "Розробка морських антидронових бонових загороджень для акваторії порту в рамках логістичних систем національної безпеки та оборони" на конкурс МОНУ прикладних наукових досліджень.
Викладачі та аспіранти кафедри беруть активну участь у міжнародному науковому проєкті «Blue Gates».</p>
    ...
    >
      ...
      <Eye size={18} className={activeDoc === doc.file ? 'text-[#1a2c3d]' : 'text-slate-300'} />
            ...
            <div className="w-full lg:w-1/2 lg:sticky lg:top-10">
              <div className="bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 p-4 min-h-[600px] max-h-[85vh] overflow-y-auto">
                {loading ? (
