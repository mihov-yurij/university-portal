      ...
      <div className="max-w-2xl mx-auto space-y-8">
        <p className="text-lg md:text-xl text-white/90 leading-relaxed font-light text-left border-l-4 border-yellow-400/30 pl-6">
          ...
          але її витоки сягають корінням 30-років минулого сторіччя, коли були створені кафедра соціально-економічних диcциплін та експлуатації морського транспорту.
                  ...
                  «Підприємництво, торгівля та біржова діяльність». Завідувачем кафедри став багаторічний керівник кафедри «Економічна теорія і кібернетика», доктор економічних наук,професор Геннадій Сергійович Махуренко.</p> 
                <div>
          <img 
          src="/lecturers/mahurenko.jpeg" 
          className="float-left mr-6 mb-4 rounded-xl border border-white/10 shadow-lg w-56 h-auto object-cover"  
          alt="Стажування 1"/>
          <p className="text-lg md:text-xl text-white/90 leading-relaxed font-light text-left border-l-4 border-yellow-400/30 pl-6">   У 2018 році кафедра стала випускаючою ще за одною спеціальністю – 242
          ...
          у міжнародних форумах, присвячених Цілям сталого розвитку (SDG).</p></div>
         <div>
          <img 
          src="/lecturers/savelieva.png" 
          className="float-left mr-6 mb-4 rounded-xl border border-white/10 shadow-lg w-56 h-auto object-cover"  
          alt="Стажування 1"/>
<p className="text-lg md:text-xl text-white/90 leading-relaxed font-light  border-l-4 border-yellow-400/30 pl-6"> Амбасадором та організатором виступає професор Савельєва В.В.  На кафедрі працюють викладачі, які відповідають за випуск фахового збірника наукових праць категорії Б «Розвиток методів управління  та  господарювання  на
...
першопрохідцем  підприємницької  науки в  транспортній галузі. Головним редактором збірнику є проректор з НР Савельєва І.В.</p>
...
<div className="overflow-hidden">
  ...
  <p className="text-lg md:text-xl text-white/90 leading-relaxed font-light">
    ...
    У 2019 році у відповідь на виклики часу та запит на інноваційні компетенції у студентів на кафедрі був створений підприємницький клуб YEP! ОНМУ , який об’єднав креативну студентську мо-
                  лодь, ініціативних викладачів та передових бізнесменів. </p></div>
             <div className="overflow-hidden"> 
  <img 
    src="/lecturers/grebenik.png" 
    className="float-left mr-6 mb-4 rounded-xl border border-white/10 shadow-lg w-56 h-auto object-cover"
    alt="Гребенник Н.Г." />
                    <p className="text-lg md:text-xl text-white/90 leading-relaxed font-light">Кожний семестр проводиться конкурс стар-
