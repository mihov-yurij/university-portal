...
у міжнародних форумах, присвячених Цілям сталого розвитку (SDG).</p>
<div>
          <img 
          src="/lecturers/savelieva.jpg" 
...
<div className="overflow-hidden"> {/* Обертка для чистого флоата */}
  ...
  <p className="text-lg md:text-xl text-white/90 leading-relaxed font-light">
    <span className="text-yellow-400 font-medium">Відповідальним секретарем</span> є нинішня завідуюча кафедри Наврозова Ю.О. 
